			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "">
						...
						<input class="input100" type="password" name="passconfirm" placeholder="Renter password" id="passconfirm">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						<button  class="login100-form-btn" onclick="createUser();" type="button" >
							Register
						</button>
						<button  class="login100-form-btn" style="margin-left:40px; background:#fff;">
